...
# Given a raw data path that contains txt file ground truths and the
# export-to path, one can instantiate an instance of dir_manager and call
# process_diff_dataset to extract ground truth images from the raw data
# into interpretable format for the torchreid engine's Market1501's Image Manager.
class dir_manager():
